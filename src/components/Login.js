        ...
        <div id="login-form" className="login-container">
            ...
            <div id="login-img" className="image-container">
                <div className="text-content">
                    <h2>Join OtakuFlix today!</h2>
                    <p>Dive into a world of endless anime adventures, discover amazing series and share your passion for Japanese animation with fellow otaku!</p>
                    <img src="images/login.gif" alt="Computer man" className="login-img" />
                </div>
